...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (selectedTable) {
                mesaInput.value = selectedTable; // Preenche o campo com a mesa selecionada
            }
        });
    </script>
...
<script>
    ...
    document.getElementById('comandaForm').addEventListener('submit', function(event) {
        ...
        document.getElementById('pedido').value = ''; // Limpa o campo de pedido
    ...
    // Limpa produtosSelecionados do localStorage ao carregar a página
    localStorage.removeItem('produtosSelecionados');
